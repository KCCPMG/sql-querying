...
SELECT app_name, rating, reviews, price FROM analytics WHERE price BETWEEN 0.10 AND 1 ORDER BY reviews DESC LIMIT 10;
...
SELECT app_name, reviews, min_installs, (min_installs / reviews) AS installs_to_reviews FROM analytics WHERE min_installs > 100000 ORDER BY installs_to_reviews DESC LIMIT 1;